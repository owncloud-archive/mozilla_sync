...
"Auto create sync account enabled" => "Autocrear una cuenta sync habilitáu",
"Auto create sync account disabled" => "Autocrear una cuenta sync desabilitáu",
...
"Auto create sync account" => "Autocrear una cuenta sync",
"When activated, the Mozilla Sync registration API will be disabled and instead accounts will be auto created using a user's existing credentials" => "Cuando s'active, l'API de rexistru de Mozilla Sync deshabilitarase y en sustitución de cuentes s'autocrearán usando credenciales esistentes",
...
"To use Mozilla Sync enter the credentials in to Mozilla Sync client" => "Pa usar Mozilla Sync inxerte les credenciales nel cliente de Mozilla Sync",
