...
"To deactivate the quota set it to zero." => "할당량을 사용하지 않으려면 0으로 설정하십시오.",
"Installed version" => "설치된 버전",
"Please set an email address in your account settings." => "계정 설정에서 이메일 주소를 입력하십시오.",
"Be sure to set the LDAP login filter to something like %s." => "LDAP 로그인 필터를 %s와(과) 비슷하게 설정하십시오.",
"Configure the special attribute Email in your LDAP configuration accordingly." => "LDAP 설정의 특별 속성 Email을 올바르게 설정하십시오.",
