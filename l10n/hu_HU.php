...
"Auto create sync account enabled" => "Automatikus szinkronizáló fiók létrehozása engedélyezve",
"Auto create sync account disabled" => "Automatikus szinkronizáló fiók létrehozása tiltva",
...
"Auto create sync account" => "Automatikus szinkronizáló fiók létrehozása",
"When activated, the Mozilla Sync registration API will be disabled and instead accounts will be auto created using a user's existing credentials" => "Amikor engedélyezve van, a Mozilla Sync regisztráció API tiltva lesz és helyette a fiókok automatikusan létrejönnek a felhasználók létező igazolásai alapján",
...
"To use Mozilla Sync enter the credentials in to Mozilla Sync client" => "A Mozilla Sync használatához írd be az igazolásokat a Mozilla Sync kliensbe.",
...
"Last sync:" => "Utoljára szinkronizálva:",
"Size of stored data:" => "Tárolt adatok mérete:",
"No data stored yet." => "Még nincs tárolt adat.",
"Number of synced devices:" => "Szinkronizált eszközök száma:",
