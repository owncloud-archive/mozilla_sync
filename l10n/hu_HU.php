...
"Please set an email address in your account settings." => "Kérjük a személyes beállításaiban adja meg az e-mail címét.",
"Be sure to set the LDAP login filter to something like %s." => "Az LDAP bejelentkezési szűrőt állítsa be valami ehhez hasonlóra: %s.",
"Configure the special attribute Email in your LDAP configuration accordingly." => "Az LDAP-beállításokban válassza ki a megfelelő e-mail attribútumot!",
